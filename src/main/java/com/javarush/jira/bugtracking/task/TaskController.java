...
public class TaskController {
    ...
    public String getTimeInWorkAndTesting(@PathVariable long id){
        log.info("get the task id={} was in progress",id);
        return taskService.getTimeTaskInWork(id) + " " + taskService.getTimeTaskInTesting(id);
    }
}
